...
/**
 Holds 2 items of potentially different types.  Designed to let you easily create immutable
 subclasses (to give your data structures meaningful names) with correct equals(), hashCode(), and
 toString() methods.

 A sub-class, {@link org.organicdesign.fp.collections.KeyValuePair} now implements Map.Entry,
 UnMap.UnEntry, and Serializable.
 */
