...
public class SequenceTest {
    ...
    @Test public void objectMethods() {
        ...
        assertEquals(UnIterableOrdered.hashCode(seq1), UnIterableOrdered.hashCode(seq2));
        ...
        assertEquals(UnIterableOrdered.hashCode(seq1.tail()), UnIterableOrdered.hashCode(seq2.tail()));
        assertTrue(UnIterableOrdered.equals(seq1.tail(), seq2.tail()));
        assertTrue(UnIterableOrdered.equals(seq2.tail(), seq1.tail()));

        assertNotEquals(UnIterableOrdered.hashCode(seq1.tail()), UnIterableOrdered.hashCode(seq2));
        assertNotEquals(UnIterableOrdered.hashCode(seq1), UnIterableOrdered.hashCode(seq2.tail()));
