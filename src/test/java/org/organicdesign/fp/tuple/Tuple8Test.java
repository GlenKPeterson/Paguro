...
public class Tuple8Test {
    @Test public void constructionAndAccess() {
        ...
        Tuple8<String,String,String,String,String,String,String,String> ser = serializeDeserialize(a);
        ...
        equalsDistinctHashCode(Tuple8.of("1st",null,"3rd",null,"5th",null,"7th",null),
                               serializeDeserialize(Tuple8.of("1st",null,"3rd",null,"5th",null,"7th",null)),
        ...
        equalsDistinctHashCode(Tuple8.of(null,"2nd",null,"4th",null,"6th",null,"8th"),
                               serializeDeserialize(Tuple8.of(null,"2nd",null,"4th",null,"6th",null,"8th")),
        ...
        assertEquals("Tuple8(\"1st\",\"2nd\",\"3rd\",\"4th\",\"5th\",\"6th\",\"7th\",\"8th\")", ser.toString());
    }
}
