UncleJim ("**Un**modifiable **Coll**ections for **J**ava&trade; **Imm**utability") brings immutable collections, a Sequence abstraction, and other Functional Programming benefits to Java.
...
Currently an *** Alpha Release ***.  The API is subject to minor changes, but test coverage is above 85%:
