Uncle Jim (or UnColl JImm from **Un**modifiable **Coll**ections for **J**ava&trade; **Imm**utability) brings immutable collections, a Sequence abstraction, and other Functional Programming benefits to Java.
