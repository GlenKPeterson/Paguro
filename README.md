...
* Encourages expressions (which evaluate) over Statements (which return void).  This has the happy side effect of leveraging the best aspects of Java's type inference capabilities so that you generally don't have to specify types unless you want to, yet the type-checker "keeps you honest."
